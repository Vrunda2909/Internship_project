...
public class QueryFourActivity extends AppCompatActivity {
    ...
    String []  imagedefaultlist = {"queryone_defaultone","queryone_defaultone","queryfour_defaultone","queryfour_defaultone","queryfour_defaultone"};
    String []  imagetruelist = {"queryfour_trueone","queryfour_truetwo","queryfour_truethree","queryfour_truefour","queryfour_truefive"};
...
//    int []  imagefalselist = {R.drawable.onefalse,R.drawable.twofasle};
    int []  linklist = {R.string.queryfive_linkone,R.string.queryfive_linktwo,R.string.queryfive_linkthree,R.string.queryfive_linkfour,R.string.queryfive_linkfive};
    int imagecounter = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_query_four);
...
//        setimage = findViewById(R.id.setimage);
        ...
        list.add(new QueryQuestionModel("Write the SQL statement selects all customers with a country containing the pattern \"an\"",
                "","select*fromcustomerswherecountrylike'%an%';"));
        list.add(new QueryQuestionModel("Write the SQL statement creates two aliases, one for the ID column and one for the Name column",
                "","selectidascustomerid,customerascustomernamefromcustomers;"));
        list.add(new QueryQuestionModel("Write the SQL statement lists the number of customers in each country",
                "","selectcount(id),countryfromcustomersgroupbycountry;"));
        list.add(new QueryQuestionModel("Write the SQL statement returns TRUE and lists the product names if it finds ANY records in the OrderDetails table that quantity = 10",
                "","selectproductnamefromproductswhereproductid=any(selectproductidfromorderdetailswherequantity=10);"));
        list.add(new QueryQuestionModel("Write the SQL adds an \"City\" column to the \"Customers\" table",
                "","altertablecustomersaddcityvarchar(255);"));
                ...
                if(position == list.size()){
                    ...
                    reff.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(iqueryfour == 0){
                                reff.child("queryfour").setValue(score);
                            }else{
                                if(iqueryfour > score){
                                    reff.child("queryfour").setValue(iqueryfour);
                                }else{
                                    reff.child("queryfour").setValue(score);
                                }
                            }
                            ...
                            if (iqueryvalue == 0){
                                ...
                                if(score > iqueryfour){
                                    if(iqueryone == 0 && iquerytwo == 0 && iquerythree == 0 && iqueryfive ==0){
                                    ...
                                    }else if(iqueryone != 0 && iquerytwo == 0 && iquerythree == 0 && iqueryfive ==0){
                                        ...
                                        float fqueryvalue = (score + iqueryone +iquerytwo +iquerythree +iqueryfive)/5;
                                        reff.child("queryvalue").setValue(fqueryvalue);
...
//            Toast.makeText(getApplicationContext(), "Wrong Answer", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed(){
        new AlertDialog.Builder(QueryFourActivity.this).setTitle("Exit")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        SharedPreferences sp = PreferenceManager
                                .getDefaultSharedPreferences(QueryFourActivity.this);
